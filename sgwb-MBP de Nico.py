...
plt.axvline(1e7,color="black",linewidth=1,linestyle="--")
plt.axvline(1e8,color="black",linewidth=1)
plt.axvline(1e9,color="black",linewidth=1,linestyle=":")
...
plt.axvline(1.5,color="black",linewidth=2,linestyle=":")
plt.xlim(1,10)
ax=plt.gca()
ax.xaxis.set_major_formatter(ScalarFormatter())
ax.xaxis.set_minor_formatter(NullFormatter())
#plt.xticks([])
plt.xticks([1,1.5,5,10],['1','1.5','5','10'])
#plt.yticks()
plt.legend()
